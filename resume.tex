...
\rsection{Experience}
  \begin{rsectionlist}
    \rsectionitem
      ...
      \begin{rpointlist}
        \rpointlone{Designing a compiler and runtime with support for efficiently executing
          incomplete programs: \emph{Compiling Functional Programs with Holes} won 2nd place at the
          2022 International Conference on Functional Programming Student Research Competition.}
