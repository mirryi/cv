...
\rsection{Education}
  \begin{rsectionlist}
    \rsectionitem
      ...
      {Ann Arbor, MI}
      {B.S.E. in Computer Science, GPA: 4.00}
      {Aug. 2021 -- May 2024}
      ...
      \rsectiondesc{
        \begin{rpointlist}
          \rpoint
            {Minors}
            {Mathematics, Asian Languages \& Cultures}
          \rpoint
            {Technical Coursework}
            {Advanced Programming Languages, Compiler Construction,
              Introduction to Operating Systems, Category Theory, Foundations of Computer Science,
          ...
          \rpoint
            {Language Coursework}
            {Practicum in Japanese Translation, Academic Japanese,
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        Participated in an two-month summer study abroad focused at Osaka Graduate University in
        Osaka, Japan. Completed an intensive advanced Japanese language course and lived in
        apartment accommodations with Japanese university students.
      }
...
\rsection{Research}
  \begin{rsectionlist}
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        Developing the \emph{marked lambda calculus}, a judgmental framework for principled
        ...
        \textsc{Manuscript under review:}
        \begin{adjustwidth}{1em}{}
          E. Zhao, R. Maroof, A. Dukkipati, A. Blinn, Z. Pan, A. Blinn, C. Omar.
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        ...
        \textsc{Accepted Abstract and Poster:}
        \begin{adjustwidth}{1em}{}
          H. Chen, Y. Chen, E. Zhao.
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        ...
        environment capable of analysing and evaluating incomplete programs. I worked to integrate
...
\rsection{Teaching}
  \begin{rsectionlist}
    \rsectionitem
      ...
      \rsectiondesc{
        Teaching weekly discussion sections and conduct office hours for over 80 undergraduate students
        in an introductory course on programming language theory and design, covering topics from
        functional programming language semantics to imperative program verification and distributed
        computation models.
      }
  \end{rsectionlist}
...
\rsection{Extracurriculars}
  \begin{rsectionlist}
    \rsectionitem
      ...
      \rsectiondesc{
        Handle communications with members and department administration, organize and run
        conversation tables twice a week, and coordinate with Japanese language instructors to
        conduct special events in relation to Japanese language and culture.
      }
