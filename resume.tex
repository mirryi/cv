...
\rsection{Experience}
  \begin{rsectionlist}
    \rsectionitem
      ...
      \begin{rpointlist}
        \rpointlone{Designing a WebAssembly-based compiler and runtime with support for executing
          incomplete programs; ``Compiling Functional Programs with Holes'' won 2nd place at the
          ICFP 2022 Student Research Competition, undergraduate category.}
        \rpointlone{Integrating primitive String type and expressions, environment-based evaluation,
          live testing, and concurrent evaluation.}
        \rpointlone{Mechanizing recursive types with holes and Hazel's error hole localization semantics
