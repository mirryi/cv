...
\rsection{Education}
  \begin{rsectionlist}
        ...
        \begin{rpointlist}
          ...
          \rpoint
            ...
            {Advanced Programming Languages, Compiler Construction,
              ...
              Introduction to Computer Organization, Data Structures and Algorithms,
              Robotic Mechanisms,
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        Participated in an two-month summer study abroad at Osaka Graduate University in Osaka,
  ...
  \begin{rsectionlist}
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        ...
        \textsc{Manuscript conditionally accepted:}
    ...
    \rsectionitem
      ...
      \rsectiondesc{
        ...
        WebAssembly, including static analyzes to optimize the speed of operations with holes.
...
\rsection{Extracurriculars}
  \begin{rsectionlist}
    \rsectionitem
      ...
      \rsectiondesc{
        Handle communications with members and department administration, organize and facilitate 
        conversation tables twice a week, coordinate with Japanese language instructors to
